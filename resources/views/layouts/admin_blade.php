  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>Gestions</a></li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Monthly</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Yearly</a></li>
